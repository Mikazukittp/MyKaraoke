Generation.create(name: '10代', value: 10)
Generation.create(name: '20代', value: 20)
Generation.create(name: '30代', value: 30)
Generation.create(name: '40代', value: 40)
Generation.create(name: '50代', value: 50)
...
UserType.create(generation_id: 2, gender_id:2)
UserType.create(generation_id: 3, gender_id:1)
UserType.create(generation_id: 3, gender_id:2)
UserType.create(generation_id: 4, gender_id:1)
UserType.create(generation_id: 4, gender_id:2)
UserType.create(generation_id: 5, gender_id:1)
UserType.create(generation_id: 5, gender_id:2)
